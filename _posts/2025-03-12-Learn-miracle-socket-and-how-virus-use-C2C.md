...
+ Ẩn file người dùng hiện tại và thay thế bằng các file exe (application) cùng tên với file gốc. Các file exe này sẽ có cùng icon như file người dùng nhằm lừa người dùng tiếp tục thực thi -> khi người dùng click, mã độc tiếp tục lây lan UwU
